package alserdar89.onewaymessage.welcome_screen

import alserdar89.onewaymessage.Launcher
...
class WelcomeActivity : AppCompatActivity() {  private lateinit var viewPager: ViewPager
